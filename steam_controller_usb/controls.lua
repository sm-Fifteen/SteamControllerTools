...
------------------------------------------------------
-- Type 0xAE : Query serial number
------------------------------------------------------

------------------------------------------------------
-- Type 0xBA : Query config ID? Controller GUID? (localconfig.vdf -> controller_registration)
------------------------------------------------------
...
------------------------------------------------------
-- Configure 0x32 : Idle timeout?
------------------------------------------------------

-- 32 84 03 -> 0x0384 -> 900 -> 15 min
